...
/**
 * Implements Lb Instruction
 * @author vedratn
 */
public class Lb extends R2ImmLS implements Cloneable{
    /**
     ...
     */
    public Lb(int rtIndex, int rsIndex, int signExtImm, int id) {
    ...
    /**
     * <p> Only child specific logic in execution of Lb instruction </p>
