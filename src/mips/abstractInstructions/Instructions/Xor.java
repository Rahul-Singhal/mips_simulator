...
/**
 * Implements Binary "Xor" Instruction 
 * @author rahul
 */
public class Xor extends R3 implements Cloneable{
     ...
     * @param xor instruction to be copied
     */
    public Xor(Xor xor){
        super(xor);
    }
    ...
    /**
     * <p> Only child specific logic in execution of Xor instruction </p>
     * <p>Calculates value of sum by taking bitwise Xor of a and b </p>
     */
