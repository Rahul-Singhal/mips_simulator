...
/**
 * <p> Implements Srav Instruction (Shift Right Arithmetic with shift amount coming from a register) </p>
 * 
 * @author rahul
 */
public class Srav extends R3 implements Cloneable{
     ...
     * @param srav instruction to be copied
     */
    ...
    /**
     * <p> Only child specific logic in execution of Srav instruction </p>
