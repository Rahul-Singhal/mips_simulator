...
import mips.abstractInstructions.RImm;
...
public class Lui extends RImm implements Cloneable{
     ...
     * <p> Calls the super Constructor of {@link mips.abstractInstructions.RImm} </p>
    ...
    /**
     *  Copy Constructor, calls super Copy Constructor of {@link mips.abstractInstructions.RImm} 
    ...
    /**
     * <p> Calls execute of {@link mips.abstractInstructions.RImm} </p>
     * <p> Calculation of immediate is required in EX Stage, so during that call {@link #calculate()} is called before {@link mips.abstractInstructions.RImm#execute(int) } </p>
     * 
