...
import mips.abstractInstructions.R2Iden;
...
public class Bne extends R2Iden implements Cloneable{
     ...
     * <p> Calls the super Constructor of {@link mips.abstractInstructions.R2Iden} </p>
    ...
    /**
     *  Copy Constructor, calls super Copy Constructor of {@link mips.abstractInstructions.R2Iden} 
    ...
    /**
     * <p> Only child specific logic in execution of Bne instruction </p>
    ...
    /**
     * <p> Calls execute of {@link mips.abstractInstructions.R2Iden} </p>
     * <p> Calculation of "branchPredicate" is required in ID/EX Stage, so during that call {@link #calculate()} is called before {@link mips.abstractInstructions.R2Iden#execute(int) } </p>
     * 
