...
/**
 * Implements Binary "Or" Instruction 
 * @author rahul
 */
public class Or extends R3 implements Cloneable{
     ...
     * @param or instruction to be copied
     */
    public Or(Or or){
        super(or);
    }
    ...
    /**
     * <p> Only child specific logic in execution of Or instruction </p>
     * <p>Calculates value of sum by taking bitwise Or of a and b </p>
     */
